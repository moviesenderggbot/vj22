...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/autofilterupdate/5")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002055683410 -1002126906819').split()]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'xyz_problem_bot') # owner username without @
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/autofilterupdate/4')

# Shortlink Info
SHORTLINK_MODE = bool(environ.get('SHORTLINK_MODE', True))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'Successfully added shortlink API for MOVIES REQUESTGROUP.

Current Shortlink Website: zipshort.net
Current API: 43fcba24ca148f6e395f86b33efe567d25f33bd7)
